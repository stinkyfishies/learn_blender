...
const LEARNING_PATHS = [
  {
    ...
    modules: [
      ...
      { idx: 11, note: "First projects" },
      { idx: 16, note: "Rendering" },
      { idx: 17, note: "Procedural textures" },
    ],
  },
  {
    ...
    modules: [
      ...
      { idx: 11, note: "First projects" },
      { idx: 15, note: "Physics & simulation" },
      { idx: 16, note: "Rendering" },
    ],
  },
  {
  ...
  },
  {
    ...
    modules: [
      ...
      { idx: 16, note: "Headless rendering" },
      { idx: 17, note: "Procedural textures via code" },
    ],
  },
];
