...
!! On first open, "remote data unavailable" or "sync required" is normal: the local index hasn't been downloaded yet. Click "Allow Online Access" when prompted. If the sync still fails, a VPN or proxy is the most likely cause: disconnect it and retry.`,
      },
      {
